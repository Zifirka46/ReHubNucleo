...
void setupEncod(){
    encodHipLeftLink.setOffset(-102);
    encodKneeLeftLink.setOffset(-492);
    encodFootLeftLink.setOffset(-445);
    encodHipRightLink.setOffset(-539);
    encodKneeRightLink.setOffset(-336);
    encodFootRightLink.setOffset(-506);
}
