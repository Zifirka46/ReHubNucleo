...
void setupEncod(){
    ...
    encodKneeLeftLink.setOffset(-841);
    encodFootLeftLink.setOffset(-570);
...
// DHX711 scaleHipLeft(PIN_TENZO_HIP_LEFT_DT, PIN_TENZO_HIP_LEFT_SCK, SCALE_HIP_LEFT_COEF);
...
// DHX711 scaleFootRight2(PIN_TENZO_FOOT_RIGHT_DT2, PIN_TENZO_FOOT_RIGHT_SCK2, SCALE_FOOT2_RIGHT_COEF);
